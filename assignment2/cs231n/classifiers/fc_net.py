...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        z1_out, cache1 = affine_relu_forward(X, W1, b1)
        a2_out, a2_cache = affine_forward(z1_out, W2, b2)
        ...
        dz1, grads['W2'], grads['b2'] = affine_backward(dx_softmax, a2_cache)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for curr_layer in range(self.num_layers - 1, 0, -1):
            ...
            loss += 0.5 * self.reg * np.sum(curr_weight * curr_weight)
            grads[f'W{curr_layer}'] += self.reg * curr_weight
